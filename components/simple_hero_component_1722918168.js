...
*/
Vue.component("simple_hero_component_1722918168", {
    template: `
            ...
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 rounded-lg backdrop-filter backdrop-blur-lg p-8 shadow-lg">
                    ...
                    <div id="hero-title-container-text" class="flex">
                        <h1 id="hero-title" class="flex-1 max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-white">Discover the Latest Blockchain Innovations</h1>
                    </div>
                    ...
                    <div id="hero-buttons-container" class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <div id="hero-button-1-container" class="flex">
                            <a id="hero-button-1" href="https://github.com/themesberg/landwind" class="flex-1 items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-white border border-white rounded-lg sm:w-auto hover:bg-white hover:bg-opacity-20 focus:ring-4 focus:ring-white focus:ring-opacity-50 transition duration-300">Explore Now</a>
                        </div>

                        <div id="hero-button-2-container" class="flex">
                            <a id="hero-button-2" href="https://www.figma.com/community/file/1125744163617429490" class="flex-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-white bg-purple-600 bg-opacity-50 border border-purple-600 rounded-lg sm:w-auto focus:outline-none hover:bg-purple-700 hover:bg-opacity-70 focus:ring-4 focus:ring-purple-500 focus:ring-opacity-50 transition duration-300">Learn More</a>
                        </div>
                    </div>
